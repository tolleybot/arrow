...
TEST_F(DatasetEncryptionTest, WriteReadDatasetWithEncryption) {
  this->WriteReadDatasetWithEncryption();
}

TEST_F(DatasetEncryptionTest, WriteReadSingleFile) { this->WriteReadSingleFile(); }

TEST_F(DatasetEncryptionTest, CannotReadMetadataWithEncryptedFooter) {
  this->CannotReadMetadataWithEncryptedFooter();
}
