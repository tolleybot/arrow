...
class DatasetEncryptionTest : public ::testing::Test {
 public:
  static void SetUpTestSuite() {
    ...
    std::string temp_dir_path_ = "/Users/dtolley/Documents/temp";
    ...
    write_options.base_dir = temp_dir_path_;
    write_options.basename_template = "part{i}.parquet";
    write_options.partitioning = std::make_shared<arrow::dataset::DirectoryPartitioning>(
        arrow::schema({}));
  ...
  static void CreateRandomTable() {
    ...
    foo_array = rand_gen.Float32(row_count, 0.0, 1.0, false); // Generate random float32 array
 ...
 protected:
  ...
  inline static std::shared_ptr<parquet::encryption::KmsConnectionConfig> kms_connection_config_;
  std::string temp_dir_path_;
};

// Test for writing and reading encrypted dataset
TEST_F(DatasetEncryptionTest, WriteReadEncryptedColumn) {
  ...
  // Set use_threads to false TODO: DON
